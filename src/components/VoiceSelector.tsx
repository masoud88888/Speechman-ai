...
export const MALE_VOICES: VoiceOption[] = [
  {
    name: "Charon",
    label: "Charon",
    description: "Informative, deep, calm, and authoritative.",
    accent: "US English",
  ...
  },
  {
    name: "Fenrir",
    label: "Fenrir",
    description: "Excitable, husky, bold, and resonant.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Puck",
    label: "Puck",
    description: "Upbeat, lively, friendly, and energetic.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Kore",
    label: "Kore",
    description: "Firm, clear, confident, and focused.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Orus",
    label: "Orus",
    description: "Firm, strong, steady, and confident.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Alnilam",
    label: "Alnilam",
    description: "Firm, controlled, clear, and authoritative.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Gacrux",
    label: "Gacrux",
    description: "Mature, composed, warm, and experienced.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Rasalgethi",
    label: "Rasalgethi",
    description: "Informative, articulate, balanced, and professional.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Algenib",
    label: "Algenib",
    description: "Gravelly, distinctive, textured, and powerful.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
  {
    name: "Sadaltager",
    label: "Sadaltager",
    description: "Knowledgeable, polished, calm, and precise.",
    accent: "US English",
    vibe: "Official Gemini Voice",
  },
];
